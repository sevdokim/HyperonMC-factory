#!/bin/bash
#
    export EVENTNUMBER=100                      # Total event number to be generated per 1 production thread  
...
do
	...
	export MESON=$MES
	for TGTPRFX in al35mm #cu7mm sn5mm pb3mm ch80mm # al35mm cu7mm sn5mm pb3mm
#	for TGTPRFX in #be79mm c78mm 
	do
		...
		*)          export THICKNESS_S4=6.000  ;; #default value (6mm) 
		...
		export PRODUCTION_NAME=$PERIOD_PRFX$TGT_PRFX  # production name
		export PRODUCTION_NAME=${PRODUCTION_NAME}_${MES}_Swave_${HYCONDITION}
		export HYMC_CONFIG_DEFINED=yes
		export CONTROL=$c
		echo " "
		echo  MESON =                $MESON
