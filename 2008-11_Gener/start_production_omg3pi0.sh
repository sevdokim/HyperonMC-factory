...
#	for TGTPRFX in al35mm cu7mm sn5mm pb3mm c78mm be79mm # al35mm cu7mm sn5mm pb3mm
	...
	do
	    for channel in 1001 1002 1003 1004 #channel is control parameter for omg exclusive channel selection 
	    do
		MESON=${MES}
		...
		export PRODUCTION_NAME=${PRODUCTION_NAME}_${MESON}
		case "$channel" in
		    "1001")  export PRODUCTION_NAME=${PRODUCTION_NAME}pi0gamma ;;
