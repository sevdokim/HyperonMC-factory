...
#
export TARGET=19             # Hyperon Tgts for GEANT (2=Be, 10=C, 3=Al35mm, 4=Al17mm, 5=Cu3mm, 9=Cu7, 8=Sn, 7=Pb, 11=ch80) 
export EXTARGET=2            # All exclusive targets of Hyperon setup: 1=S4, 2=target, 3=Sa, 0=all of them
#
...
export DELTA_SA=0             # SA  shift in mm relative to the nominal position
