...
for prod in $(cat productions_PDG_s4eff.list)
do 
    reconvert_production $prod /afs/ihep.su/user/s/sevdokim/HyperonMC-factory/2008-11_Gener 2008-11 200
done
