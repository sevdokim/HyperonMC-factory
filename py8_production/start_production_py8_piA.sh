...
do
    ...
    for MES in incl_piA #f2 #omg #eta f2 2pi0 K0 # f0
    do 	
	case "$MES" in
            "pi0")     n=1 ;;
            "eta")     n=2 ;;
	...
	export MESON=$MES
	for TGTPRFX in be79mm al35mm cu7mm sn5mm #pb3mm c78mm be79mm ch80mm # al35mm cu7mm sn5mm pb3mm
#	for TGTPRFX in pb3mm al35mm cu7mm sn5mm c78mm be79mm
#	for TGTPRFX in be60mm # c60mm s60mm
#	for TGTPRFX in #pb3mm c78mm # pb3mm
	do
	    case "$TGTPRFX" in
		"be79mm")  export PY8CONFIG=py8Config_pi9Be.cfg ;;
		"c78mm")   export PY8CONFIG=py8Config_pi12C.cfg ;;
		"al35mm")  export PY8CONFIG=py8Config_pi27Al.cfg ;;
		"cu7mm")   export PY8CONFIG=py8Config_pi63Cu.cfg ;;
		"sn5mm")   export PY8CONFIG=py8Config_pi120Sn.cfg ;;
		"pb3mm")   export PY8CONFIG=py8Config_pi208Pb.cfg ;;
            esac
