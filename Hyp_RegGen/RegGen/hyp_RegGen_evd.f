...
C-       Pc(5) = Amf2 + (s2f2/2.36)*rnd_gauss(1.)   !  Simple Gauss
         ...
         if(width_f2.le.0.0) width_f2 = 185.1
c         call BW_rand_f2(1275.1, 185.1,rnd_BW) !  GAMS BW for f2(1275)
         call BW_rand_f2(1275.1, width_f2,rnd_BW) !  GAMS BW for f2(1275)
...
c30         write(*,*) 'f2 generator: I generated T = ', Tf2
...
C
      if (Nreson.eq.8.or.Nreson.eq.9) then  !  resonance = pi0 (8) or eta (9) monochromatic for Z MC calibration 
C                                           !  i.e. fixed T and Missing Mass  
      T = -0.005 
      MissMass = 0.938272
      endif      
C      
