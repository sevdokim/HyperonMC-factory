...
HyGeoParameters::HyGeoParameters():TObject(),
	S4Dist(0.0),                         // Center of the coordinate system
	S4Radius(6.0),
...
//	SaDist(50.45),                       // new Sa position from 1.04.2015
	SaWidth(20.),
	SaThickness(1.5),
...
Double_t HyGeoParameters::GetMembraneBlockLength(){return MembraneBlockLength;}
...
void HyGeoParameters::SetMembraneBlockLength(Double_t a){MembraneBlockLength=a;}
